...
class _BubblePainter extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    paint.shader = ui.Gradient.linear(Offset(offset.dx, configuration.size.height - indicatorHeight), Offset(offset.dx + configuration.size.width, configuration.size.height - indicatorHeight), <Color>[
      Colors.red,
      Colors.green
    ]);
    canvas.drawRRect(
