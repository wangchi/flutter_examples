...
class GetImageSizeDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Get Image Info Demo')
      ),
      body: Container(
  ...
  Widget imageDemo() {
    var imageUrl = 'https://images.unsplash.com/photo-1545546900-d1be172f37b6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60';
